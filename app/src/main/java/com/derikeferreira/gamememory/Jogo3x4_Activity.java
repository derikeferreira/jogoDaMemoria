...
public class Jogo3x4_Activity extends AppCompatActivity {
    ...
    private void configuracoesIniciais(){
        ...
        imagem_L1xC1 = findViewById(R.id.imgMatriz_3x4_L1xC1);
        imagem_L1xC2 = findViewById(R.id.imgMatriz_3x4_L1xC2);
        imagem_L1xC3 = findViewById(R.id.imgMatriz_3x4_L1xC3);
        imagem_L1xC4 = findViewById(R.id.imgMatriz_3x4_L1xC4);
        imagem_L2xC1 = findViewById(R.id.imgMatriz_3x4_L2xC1);
        imagem_L2xC2 = findViewById(R.id.imgMatriz_3x4_L2xC2);
        imagem_L2xC3 = findViewById(R.id.imgMatriz_3x4_L2xC3);
        imagem_L2xC4 = findViewById(R.id.imgMatriz_3x4_L2xC4);
        imagem_L3xC1 = findViewById(R.id.imgMatriz_3x4_L3xC1);
        imagem_L3xC2 = findViewById(R.id.imgMatriz_3x4_L3xC2);
        imagem_L3xC3 = findViewById(R.id.imgMatriz_3x4_L3xC3);
        imagem_L3xC4 = findViewById(R.id.imgMatriz_3x4_L3xC4);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(contaTempo > 0) {
                            ...
                            Toast.makeText(Jogo3x4_Activity.this, "Seu tempo acabou!", Toast.LENGTH_LONG).show();
                            finish();
