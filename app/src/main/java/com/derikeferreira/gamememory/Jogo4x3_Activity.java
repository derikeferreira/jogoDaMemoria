...
public class Jogo4x3_Activity extends AppCompatActivity {
    ...
    private ImageView imagem_L1xC1, imagem_L1xC2, imagem_L1xC3;
    private ImageView imagem_L2xC1, imagem_L2xC2, imagem_L2xC3;
    private ImageView imagem_L3xC1, imagem_L3xC2, imagem_L3xC3;
    private ImageView imagem_L4xC1, imagem_L4xC2, imagem_L4xC3;
    ...
    private Integer[] arrayPosicoesImg = {101,102, 103, 104, 105, 106, 201, 202, 203, 204, 205, 206};
    //numero das imagens
    private int imagemJogo1, imagemJogo2, imagemJogo3,imagemJogo4, imagemJogo5,imagemJogo6,imagemJogo7,imagemJogo8,imagemJogo9,imagemJogo10,imagemJogo11,imagemJogo12;
    private int imagemEscolha1, imagemEscolha2;
    private int cliqueImagem1, cliqueImagem2;
    private int imagemNumero = 1;
    private int pontos = 9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo4x3);
    ...
    private void configuracoesIniciais(){
        ...
        imagem_L1xC1 = findViewById(R.id.imgMatriz_4x3_L1xC1);
        imagem_L1xC2 = findViewById(R.id.imgMatriz_4x3_L1xC2);
        imagem_L1xC3 = findViewById(R.id.imgMatriz_4x3_L1xC3);
        imagem_L2xC1 = findViewById(R.id.imgMatriz_4x3_L2xC1);
        imagem_L2xC2 = findViewById(R.id.imgMatriz_4x3_L2xC2);
        imagem_L2xC3 = findViewById(R.id.imgMatriz_4x3_L2xC3);
        imagem_L3xC1 = findViewById(R.id.imgMatriz_4x3_L3xC1);
        imagem_L3xC2 = findViewById(R.id.imgMatriz_4x3_L3xC2);
        imagem_L3xC3 = findViewById(R.id.imgMatriz_4x3_L3xC3);
        imagem_L4xC1 = findViewById(R.id.imgMatriz_4x3_L4xC1);
        imagem_L4xC2 = findViewById(R.id.imgMatriz_4x3_L4xC2);
        imagem_L4xC3 = findViewById(R.id.imgMatriz_4x3_L4xC3);
        ...
        imagem_L2xC1.setTag("3");
        imagem_L2xC2.setTag("4");
        imagem_L2xC3.setTag("5");
        imagem_L3xC1.setTag("6");
        imagem_L3xC2.setTag("7");
        imagem_L3xC3.setTag("8");
        imagem_L4xC1.setTag("9");
        imagem_L4xC2.setTag("10");
        imagem_L4xC3.setTag("11");
    ...
    private void imagensParaOJogo(){
        //numero das imagens
        imagemJogo1 = R.drawable.numero5;
        imagemJogo2 = R.drawable.bomba;
        imagemJogo3 = R.drawable.numero6;
        imagemJogo4 = R.drawable.numero7;
        imagemJogo5 = R.drawable.numero8;
        imagemJogo6 = R.drawable.numero9;

        imagemJogo7 = R.drawable.numero5;
        imagemJogo8 = R.drawable.bomba;
        imagemJogo9 = R.drawable.numero6;
        imagemJogo10 = R.drawable.numero7;
        imagemJogo11 = R.drawable.numero8;
        imagemJogo12 = R.drawable.numero9;
    }
    ...
    private void verificaSeTerminouJogo() {
        ...
        if(abriuDuasImagens1 == 2 &&
            ...
            Intent trocaTela = new Intent(getApplication(), Jogo4x4_Activity.class);
