...
public class Jogo4x4_Activity extends AppCompatActivity {
    ...
    private Integer[] arrayPosicoesImg = {101,102, 103, 104, 105, 106 ,107 ,108 , 201, 202, 203, 204, 205, 206,207 ,208};
    //numero das imagens
    ...
    private int pontos = 14;
    private String exibirSom;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jogo4x4);
    ...
    private void configuracoesIniciais(){
        ...
        imagem_L1xC1 = findViewById(R.id.imgMatriz_4x4_L1xC1);
        imagem_L1xC2 = findViewById(R.id.imgMatriz_4x4_L1xC2);
        imagem_L1xC3 = findViewById(R.id.imgMatriz_4x4_L1xC3);
        imagem_L1xC4 = findViewById(R.id.imgMatriz_4x4_L1xC4);

        imagem_L2xC1 = findViewById(R.id.imgMatriz_4x4_L2xC1);
        imagem_L2xC2 = findViewById(R.id.imgMatriz_4x4_L2xC2);
        imagem_L2xC3 = findViewById(R.id.imgMatriz_4x4_L2xC3);
        imagem_L2xC4 = findViewById(R.id.imgMatriz_4x4_L2xC4);

        imagem_L3xC1 = findViewById(R.id.imgMatriz_4x4_L3xC1);
        imagem_L3xC2 = findViewById(R.id.imgMatriz_4x4_L3xC2);
        imagem_L3xC3 = findViewById(R.id.imgMatriz_4x4_L3xC3);
        imagem_L3xC4 = findViewById(R.id.imgMatriz_4x4_L3xC4);

        imagem_L4xC1 = findViewById(R.id.imgMatriz_4x4_L4xC1);
        imagem_L4xC2 = findViewById(R.id.imgMatriz_4x4_L4xC2);
        imagem_L4xC3 = findViewById(R.id.imgMatriz_4x4_L4xC3);
        imagem_L4xC4 = findViewById(R.id.imgMatriz_4x4_L4xC4);
    ...
    private void imagensParaOJogo(){
        ...
        imagemJogo9 = R.drawable.animal17;
        imagemJogo10 = R.drawable.bomba;
        imagemJogo11 = R.drawable.animal19;
        imagemJogo12 = R.drawable.animal20;
        imagemJogo13 = R.drawable.animal21;
        imagemJogo14 = R.drawable.animal22;
        imagemJogo15 = R.drawable.animal23;
        imagemJogo16 = R.drawable.animal24;
