...
public class Jogo3x2_Activity extends AppCompatActivity {
    ...
    private ImageView imagem_L3xC1, imagem_L3xC2;
    ...
    private Integer[] arrayPosicoesImg = {101,102, 103, 201, 202, 203};
    //numero das imagens
    private int imagemJogo1, imagemJogo2, imagemJogo3,imagemJogo4, imagemJogo5,imagemJogo6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo3x2);
    ...
    private void configuracoesIniciais(){
        ...
        imagem_L1xC1 = findViewById(R.id.imgMatriz_3x2_L1xC1);
        imagem_L1xC2 = findViewById(R.id.imgMatriz_3x2_L1xC2);
        imagem_L2xC1 = findViewById(R.id.imgMatriz_3x2_L2xC1);
        imagem_L2xC2 = findViewById(R.id.imgMatriz_3x2_L2xC2);
        imagem_L3xC1 = findViewById(R.id.imgMatriz_3x2_L3xC1);
        imagem_L3xC2 = findViewById(R.id.imgMatriz_3x2_L3xC2);
        ...
        imagem_L3xC1.setTag("4");
        imagem_L3xC2.setTag("5");
    ...
    private void imagensParaOJogo(){
        //numero das imagens
        imagemJogo1 = R.drawable.animal5;
        imagemJogo2 = R.drawable.bomba;
        imagemJogo3 = R.drawable.animal9;
        imagemJogo4 = R.drawable.animal5;
        imagemJogo5 = R.drawable.bomba;
        imagemJogo6 = R.drawable.animal9;
    }
    ...
    private void verificaSeTerminouJogo() {
        ...
        if(abriuDuasImagens1 == 2 && abriuDuasImagens2 == 2){
            ...
            Intent trocaTela = new Intent(getApplication(), Jogo3x4_Activity.class);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(contaTempo > 0) {
                            ...
                            Toast.makeText(Jogo3x2_Activity.this, "Seu tempo acabou!", Toast.LENGTH_LONG).show();
                            finish();
